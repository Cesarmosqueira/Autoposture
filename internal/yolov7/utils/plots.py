...
def plot_one_box_kpt(x, im, color=None, label=None, line_thickness=3, kpt_label=False, kpts=None, steps=2, cmap='good'):
    ...
    if kpt_label:
        plot_skeleton_kpts(im, kpts, steps, cmap)
...
def plot_skeleton_kpts(im, kpts, steps, cmap='good'):
    ...
    palette = np.array([[255, 128, 0], [255, 153, 51], [255, 178, 102],
                        ...
                        [255, 255, 255]]) if cmap == 'good' else \
            np.array([[0, 0, 255],   # Dark Red
                           [51, 0, 255],  # Reddish Purple
                           [102, 0, 255], # Purple
                           [0, 102, 255], # Light Blue
                           [255, 0, 255], # Magenta
                           [255, 51, 153],# Pink
                           [255, 0, 102], # Reddish Pink
                           [255, 0, 51],  # Red
                           [255, 102, 102],# Light Red
                           [255, 51, 0],  # Orangish Red
                           [10, 0, 255],  # Dark Red
                           [10, 0, 255],  # Dark Red
                           [10, 0, 255],   # Dark Red
                           [0, 153, 255], # Orange
                           [0, 102, 255], # Orange
                           [0, 51, 255],  # Orangish Red
                           [0, 20, 255],  # Green
                           [20, 0, 255],  # Red
                           [255, 255, 255]]) # White
